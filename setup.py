...
setup(
    ...
    description='Notebook Extension to do create a configuraiton file from URL query parameters',
    packages=find_packages(),
    include_package_data=True,
    platforms='any',
    install_requires=['notebook>=5.5.0', 'tornado'],
    data_files=[
        ('etc/jupyter/jupyter_notebook_config.d', ['jupyterurlparams/etc/jupyterurlparams.json'])
    ],
    zip_safe=False,
    # entry_points={
    #     'console_scripts': [
